<?php
/**
 * Plugin Name: Cloud Words
 * Description: This is a Cloud words plugins jetpack extension
 * Version:     1.0
...
<style>
    ...
    #trends a {
        ...
        padding: 3px 6px;}
    #trends a:hover {border: 1px solid lime; background: #000066; }
...
function get_posts_url(){
    ...
    foreach ($top_posts as $post_item):
        $html .= '<a href="'.$post_item['post_permalink'].'" class="special-slide">
...
window.onload = function() {
    var i = 0;
    var oTag = null;
    oDiv = document.getElementById("trends");
...
add_shortcode('nuvem', 'nuvem_palavras');
